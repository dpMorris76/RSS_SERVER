...
//		
//		@Test
//		public void addChannelByBulkEdit() {
...
//
//		// Open User Bulk Edit
//		driver.findElement(By.id("navBulkEdit")).click();
//
//		driver.findElement(By.id("checkboxLindsay, Scott")).click();
//		driver.findElement(By.id("checkboxWagner, Steven")).click();
//		driver.findElement(By.id("checkboxTest Channel")).click();
//		driver.findElement(By.className("fixedwidthbtn")).click();
//		driver.close();
//	}
//
//}
